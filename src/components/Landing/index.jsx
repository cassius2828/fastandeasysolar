const Landing = () => {
  return (
    ...
    >
      <h1 className="text-8xl font-bold text-gray-200 my-12 fade-in-scale-down ">
        Fast and Easy Solar
      </h1>
      ...
      <a href="#contact">
        <button className="text-3xl font-bold text-gray-200 border p-4 fade-in-scale-down rounded-lg ">
          See Savings
        </button>
      </a>
    </div>
