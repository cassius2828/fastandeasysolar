...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="h-screen relative z-30 flex items-center justify-center"
    >
      <div className="flex flex-col items-center justify-around lg:w-1/2 w-full py-12 mr-12 rounded-lg bg-blue-900">
        <h1 className="text-7xl text-gray-200">What is Fast and Easy Solar?</h1>
        <p className="text-3xl text-gray-200 p-12 mr-8 leading-10">
      ...
      <div className=" rounded-xl lg:w-1/3  w-full flex  items-center justify-between gap-4">
        <div
          onClick={handlePrevStep}
          className="flex items-center justify-center text-blue-900 bg-gray-200 hover:text-gray-200   hover:bg-blue-900  transition-all duration-200 ease-in-out cursor-pointer rounded-full p-2"
        >
