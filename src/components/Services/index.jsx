        ...
        <div className="relative inset-0 flex items-center justify-center p-8 h-full w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 w-9/12">
            ...
            <InfoCard
              ...
              icon={
                <UilHome className="text-center" size="100" color="#1e3a8a" />
              }
            />
            ...
            <InfoCard
              ...
              icon={
                <UilPlug className="text-center" size="100" color="#1e3a8a" />
              }
            />
            ...
            <InfoCard
              ...
              icon={
                <UilWrench className="text-center" size="100" color="#1e3a8a" />
              }
            />
            ...
            <InfoCard
              ...
              icon={
                <UilShield className="text-center" size="100" color="#1e3a8a" />
              }
            />
          </div>
        </div>
  ...
  return (
    <div className=" bg-gray-100 flex flex-col justify-around card  w-full lg:h-[50rem] text-center rounded-lg p-4">
      ...
      <div className="">
        ...
        <p className="p-4 text-blue-900 text-3xl">{text}</p>
      </div>
