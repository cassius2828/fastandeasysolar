...
export default function Programs() {
  ...
  useGSAP(() => {
    fadeInFromBottomStagger(".program-text");
  }, {});
  return (
    <section
      ...
      >
        ...
        <g transform="translate(1020 0)">
          <g transform="translate(0 735)">
            ...
            <circle fillOpacity="0.01" fill="url(#a)" r="3000" />
          </g>
        </g>
      </svg>
...
export const ProsAndConsSection = ({ data }) => {
  useGSAP(() => {
    fadeInFromSide(".Pros", { side: -50 });
    fadeInFromSide(".Cons", { side: 50 });
  }, {});
  return (
    <>
      <h4 className="program-text text-pretty text-4xl font-semibold tracking-tight text-gray-100 sm:text-5xl flex flex-col md:flex-row items-center gap-4 mt-12">
        {data.title}
        {data.icon}
      </h4>
