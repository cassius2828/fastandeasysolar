      ...
      <div>
        ...
        <div className={`my-12`}>
          ...
          <select
            ...
            name="program"
            id="program"
            className={`w-full bg-gray-100 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline border-2 ${formErrors.program && 'border-red-500'} text-xl lg:text-2xl`}
          >
