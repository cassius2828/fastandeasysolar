...
const FAQItem = ({ question, answer, idx }) => {
  return (
    <div
      className={`faq${
        idx % 2 === 0 ? "left" : "right"
      } w-full px-4 py-2 my-4 bg-gray-100 rounded-md min-h-40`}
    >
...
export const FAQList = () => {
  ...
  return (
    ...
    >
      <h2 className="faq-text text-6xl font-bold p-3 pb-0 text-gray-100 text-center">
        Frequently Asked Questions
      </h2>
      <CustomHR gsapSelector={'faq-text'} bgColor="white" />
